...
function FeatureCourses() {
  ...
  return (
    <div className="py-12 bg-gray-900">
      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-center mt-6">
        {featuredCourses.map((course: Course) => (
          <div key={course.title} className="flex justify-center">
            <BackgroundGradient className="rounded-[22px] h-[28rem] max-w-sm p-4 sm:p-10  bg-white dark:bg-zinc-900">
              <Image
                src={course.image}
                alt="jordans"
                height="400"
